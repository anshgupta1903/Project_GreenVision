...
from src.forest.entity.artifact_entity import ModelEvaluationArtifact, ModelTrainerArtifact, DataIngestionArtifact
...
class ModelEvaluation:
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        try:
            ...
            trained_model_f1_score = load_object(file_path=self.model_trainer_artifact.trained_model_file_path)
            ...
            if(best_model is not None):
                y_hat_trained_model = best_model.predict(x)
                best_model_f1_score = f1_score(y, y_hat_trained_model, average='micro')
            tmp_best_model_score = 0 if best_model_f1_score is None else best_model_f1_score
            result = EvaluateModelResponse(trained_model_f1_score=trained_model_f1_score, best_model_f1_score=best_model_f1_score,
